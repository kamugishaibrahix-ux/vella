...
const CONNECTION_PERCENT = 60;
const HEADLINE = "You're building.";
const DATE_LABEL = "Sunday, Feb 22";
const REFLECTIVE_LINE = "You've stayed consistent this week.";
      ...
      <div className={styles.shell}>
        <div className={styles.content}>
          <header className={styles.header}>
            ...
            <HeartConnection percent={CONNECTION_PERCENT} />
          </header>

          <p className={styles.reflectiveLine} aria-live="polite">
            {REFLECTIVE_LINE}
          </p>
          ...
          <div className={styles.ctaZone}>
            <Link
              ...
              aria-label="Continue to session"
            >
              Continue
            </Link>
          </div>
...
function NavIcon({ kind }: { kind: "home" | "checkin" | "session" | "journal" | "insights" }) {
  ...
  const stroke = isHome ? "var(--vella-primary)" : "#9AA0A6";
  ...
  if (kind === "checkin") {
    return (
      <svg {...common} viewBox="0 0 24 24" fill="none" aria-hidden>
        ...
        <path d="M9 12l2 2 4-5" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  }
  if (kind === "session") {
  ...
  if (kind === "journal") {
    return (
      <svg {...common} viewBox="0 0 24 24" fill="none" aria-hidden>
        <path d="M7 4h10a2 2 0 0 1 2 2v14a2 2 0 0 0-2-2H7a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2Z" strokeWidth="1.8" />
        <path d="M7 4v14" strokeWidth="1.8" />
      </svg>
    );
  }
  return (
    <svg {...common} viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="M9 18h6" strokeWidth="1.8" strokeLinecap="round" />
