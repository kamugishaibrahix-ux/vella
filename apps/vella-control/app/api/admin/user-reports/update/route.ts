...
export async function POST(request: Request) {
  ...
  try {
    ...
    await rateLimitAdmin(request, "user-reports-update", userId);
  } catch (err: unknown) {
  ...
  try {
    ...
    console.error("[api/admin/user-reports/update] Error", error);
    let message = "Failed to update user report.";
